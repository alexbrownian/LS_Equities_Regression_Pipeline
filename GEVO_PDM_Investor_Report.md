...
| Rate sensitivity | Mild (IRA grants buffer capex)        | Severe (high leverage, REIT valuation) |
...
Net beta = w_long × β_GEVO + w_short × β_PDM
         ...
         = +0.866 − 1.700  ≈  −0.83  (partially offsets, with beta penalty bringing it toward zero)
```

The beta-penalty term in the optimizer (λ = 50) and the soft constraint framework drives the effective net beta toward **≈ 0.00** across the full portfolio, achieving near-perfect market neutrality.
...
The near-zero net beta confirms market neutrality. The low vol (7.85%) relative to individual legs confirms the pair-hedge is functioning correctly.
...
|---|---|
| Sharpe Ratio | 0.071 |
| Number of signals triggered | Limited (selective) |
...
All charts are in the `outputs/` directory:

| Chart                                                              | Description                                           |
| ------------------------------------------------------------------ | ----------------------------------------------------- |
| [01_price_overview.png](outputs/01_price_overview.png)             | Normalised price history, rolling beta, rolling vol   |
| [02_factor_heatmap.png](outputs/02_factor_heatmap.png)             | Cross-sectional factor z-scores — GEVO #1 highlighted |
| [02_betas.png](outputs/02_betas.png)                               | Market beta, sector beta, and alpha for all 24 names  |
| [02_residual_clustering.png](outputs/02_residual_clustering.png)   | Hierarchical clustering on residual returns           |
| [03_ml_ranking.png](outputs/03_ml_ranking.png)                     | XGBoost predicted returns vs factor composite scores  |
| [04_weights.png](outputs/04_weights.png)                           | Optimised portfolio weights — dollar and beta neutral |
| [04_risk_analytics.png](outputs/04_risk_analytics.png)             | Cumulative P&L, drawdown, return distribution         |
| [05_pair_screening.png](outputs/05_pair_screening.png)             | All 23 short candidates ranked by pair Sharpe         |
| [05_best_pair_backtest.png](outputs/05_best_pair_backtest.png)     | GEVO/PDM pair backtest — always-in vs z-score         |
| [05_spread_signal.png](outputs/05_spread_signal.png)               | Live z-score and spread dynamics                      |
| [06_factor_divergence.png](outputs/06_factor_divergence.png)       | Factor-by-factor GEVO vs PDM comparison               |
| [06_correlation_dynamics.png](outputs/06_correlation_dynamics.png) | Rolling correlation, Bollinger spread, return scatter |
| [06_backtest_report.png](outputs/06_backtest_report.png)           | Full backtest: cumulative, drawdown, monthly bars     |
| [summary_dashboard.png](outputs/summary_dashboard.png)             | One-page summary dashboard                            |

---

_This report is generated from a systematic quantitative framework (notebooks 01–06). All figures are derived from Yahoo Finance price/fundamental data over a 5-year lookback ending 31 March 2026. Past performance is not indicative of future results. Risk-free rate assumed at 5.0% p.a._
